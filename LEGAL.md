...
Write to <contact@francois-brille.fr> with the file or passage concerned and the reason. A complaint will be acknowledged and looked at on its merits, and where it is well founded the material will be removed. That commitment is made independently of whether the objection arrives as a formal notice.
